...
#     url(r'^browse-compounds', CompoundsBrowseListView.as_view(), name='browse-compounds'),
# ]
#
# pathway_urls = [
...
#
# chembl_urls = [
#     url(r"^(?P<pk>\d+)/related-assays$", ChemblRelatedAssaysListView.as_view(), name='chembl_related_assays'),
#     url(r"^(?P<pk>\d+)/related-docs$", ChemblRelatedDocsListView.as_view(), name='chembl_related_docs'),
#     url(r"^(?P<pk>\d+)/related_targets$", ChemblRelatedTargetsListView.as_view(), name='chembl_related_targets')
# ]
#
# # url config
# urlpatterns = [
...
#     url(r'^chembl/', include(chembl_urls)),
# ]
...
# router.register(r"identity/en", EnglishIdentityViewSet)
# router.register(r"identity/ch", ChineseIdentityViewSet)
router.register(r'compounds', rest_views.CompoundViewSet)
# router.register(r'structures', StructureViewSet)
router.register(r'herbs', rest_views.HerbViewSet)
router.register(r'cids', rest_views.CIDViewSet)
router.register(r'cass', rest_views.CASViewSet)
# router.register(r'chembls', ChEMBLViewSet)
router.register(r'prescriptions', rest_views.PrescriptionViewSet)
router.register(r'keggcompounds', rest_views.KEGGCompoundViewSet)
router.register(r'keggpathways', rest_views.KEGGPathwayViewSet)
router.register(r'keggpathwaycategories', rest_views.KEGGPathwayCategoryViewSet)
# router.register(r'keggsimilarities', rest_views.KEGGSimilarityViewSet)
# router.register(r'taxonomies', TCMTaxonomyViewSet)
